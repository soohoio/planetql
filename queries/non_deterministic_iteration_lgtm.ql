...
select expr,
  "Iterable expression $@ may be an unordered collection type of $@. Iteration into unordered collection type without ordering can lead to non-deterministic iteration output.",
  expr, expr.toString(), expr.getType(), expr.getType().toString()
